// Updated App.jsx with role-based routing and new components
...
// Main App Layout with sidebar and role-based content
function HomeLayout() {
...
// Main App component with routes and role-based access
function AppRoutes() {
