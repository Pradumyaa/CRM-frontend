  ...
  return (
    <section className="relative py-24 bg-gradient-to-br from-[#5932EA] via-purple-600 to-indigo-700 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-indigo-300/5 rounded-full blur-2xl animate-pulse" style={{animationDelay: '0.5s'}}></div>
      </div>

      {/* Floating Icons */}
      <div className="absolute inset-0 pointer-events-none">
        <Sparkles className="absolute top-16 left-1/4 w-6 h-6 text-white/20 animate-bounce" style={{animationDelay: '0s'}} />
        <Zap className="absolute top-32 right-1/3 w-5 h-5 text-yellow-300/30 animate-bounce" style={{animationDelay: '0.7s'}} />
        <Users className="absolute bottom-24 left-1/3 w-5 h-5 text-blue-200/25 animate-bounce" style={{animationDelay: '1.4s'}} />
      </div>
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl sm:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed">
          Join the <strong className="text-white">healthcare revolution</strong> with BET's integrated platform. 
        ...
        <p className="mt-8 text-white/60 text-sm">
          ✨ No credit card required • Free 14-day trial • Setup in under 5 minutes
        </p>
      </div>
    </section>
  );
