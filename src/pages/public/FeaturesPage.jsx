...
const FeaturesPage = () => {
    ...
    automation: [
      {
        ...
        description: "Automatically assign tasks based on workload, skills, and availability using machine learning algorithms.",
        icon: Brain,
      ...
      },
      {
        ...
        description: "Auto-schedule meetings, reviews, and deadlines based on team availability and priorities.",
        icon: Calendar,
      ...
      },
      {
        ...
        description: "Automated employee onboarding with personalized checklists and progress tracking.",
        icon: UserCheck,
      ...
      },
      {
        ...
        description: "Forecast trends, identify bottlenecks, and predict outcomes using advanced analytics.",
        icon: TrendingUp,
      ...
      },
      {
        ...
        description: "Contextual notifications that adapt to user behavior and priority levels.",
        icon: AlertTriangle,
    ...
    analytics: [
      {
        ...
        description: "Create custom dashboards with drag-and-drop widgets and real-time data updates.",
        icon: BarChart2,
      ...
      },
      {
        ...
        description: "Deep dive into revenue patterns, forecasting, and performance optimization.",
        icon: DollarSign,
      ...
      },
      {
        ...
        description: "Visual performance indicators across teams, departments, and time periods.",
        icon: Activity,
      ...
      },
      {
        ...
        description: "Machine learning models that predict outcomes and recommend actions.",
        icon: Brain,
      ...
      },
      {
        ...
        description: "Build complex reports with filters, grouping, and automated distribution.",
        icon: FileText,
    ...
    security: [
      {
        ...
        description: "Every user and device is verified before accessing any system resources.",
        icon: Lock,
      ...
      },
      {
        ...
        description: "Automated compliance monitoring with real-time alerts and audit trails.",
        icon: Shield,
      ...
      },
      {
        ...
        description: "Military-grade 256-bit AES encryption for all data in transit and at rest.",
        icon: Lock,
      ...
      },
      {
        ...
        description: "Advanced MFA with biometric, SMS, and authenticator app support.",
        icon: UserCheck,
      ...
      },
      {
        ...
        description: "AI-powered threat detection with automatic response and mitigation.",
        icon: Eye,
      ...
      },
      {
        ...
        description: "Centralized view of all compliance requirements with automated tracking.",
        icon: BarChart2,
    ...
    integration: [
      {
        ...
        description: "Connect with 1000+ applications through our comprehensive API gateway.",
        icon: Layers,
      ...
      },
      {
        ...
        description: "Build integrations without coding using visual workflow builders.",
        icon: Workflow,
      ...
      },
      {
        ...
        description: "Bidirectional data synchronization with conflict resolution and versioning.",
        icon: RefreshCw,
      ...
      },
      {
        ...
        description: "Single Sign-On integration with SAML, OAuth, OpenID Connect, and LDAP.",
        icon: Users,
      ...
      },
      {
        ...
        description: "Trigger actions across systems with intelligent webhook management.",
        icon: Zap,
      ...
      },
      {
        ...
        description: "Seamlessly migrate data from legacy systems with validation and rollback.",
        icon: Database,
    ...
    mobile: [
      {
        ...
        description: "Native app experience in the browser with offline capabilities.",
        icon: Smartphone,
      ...
      },
      {
        ...
        description: "Control BET using voice commands for hands-free operation.",
        icon: MessageSquare,
      ...
      },
      {
        ...
        description: "Secure access using fingerprint, face recognition, and voice authentication.",
        icon: UserCheck,
      ...
      },
      {
        ...
        description: "Interface automatically adapts to screen size, orientation, and user preferences.",
        icon: Palette,
      ...
      },
      {
        ...
        description: "Continue working without internet and sync when connection is restored.",
        icon: CloudLightning,
      ...
      },
      {
        ...
        description: "Full WCAG 2.1 compliance with screen reader and keyboard navigation support.",
        icon: Eye,
    ...
    collaboration: [
      {
        ...
        description: "Multiple users can edit documents, spreadsheets, and forms simultaneously.",
        icon: Users,
      ...
      },
      {
        ...
        description: "Track team morale, workload, and engagement with sentiment analysis.",
        icon: Activity,
      ...
      },
      {
        ...
        description: "Intelligent knowledge management with automatic categorization and search.",
        icon: Database,
      ...
      },
      {
        ...
        description: "Integrated video calls with screen sharing, recording, and transcription.",
        icon: Video,
      ...
      },
      {
        ...
        description: "Interactive Gantt charts and timeline views for project management.",
        icon: BarChart2,
  ...
  const filteredFeatures = allFeatures[activeCategory].filter(feature =>
    ...
    <>
      ...
      <section className="relative pt-24 pb-20 bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple-200/40 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
              Discover the comprehensive feature set that makes BET the most advanced business enablement platform. 
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              {[
                ...
                <div key={i} className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl border border-gray-200/50 hover:shadow-lg transition-all group">
      ...
      <section className="py-24 bg-gradient-to-b from-slate-950 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {featureCategories.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <p className={`text-sm ${
                    activeCategory === category.id ? 'text-white/90' : 'text-white/70'
                  }`}>
          ...
          <div className="text-center mb-12">
            <div className={`inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r ${currentCategory.color} rounded-2xl text-white font-semibold text-xl shadow-lg`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <p className="text-gray-600">
              Showing <span className="font-semibold">{filteredFeatures.length}</span> features
              {searchTerm && (
                <span> matching "<span className="font-semibold text-[#5932EA]">{searchTerm}</span>"</span>
              )}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredFeatures.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100 hover:shadow-xl transition-all group">
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${currentCategory.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform`}>
                  ...
                  <div className="mb-6">
                    <div className={`inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r ${currentCategory.color} text-white rounded-full text-sm font-semibold`}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {feature.tags.map((tag, tagIndex) => (
                      <span key={tagIndex} className="px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full font-medium">
                        {tag}
                      </span>
                    ))}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              return (
                <div key={i} className="bg-white/5 backdrop-blur-sm p-8 rounded-2xl border border-white/10 hover:bg-white/10 transition-all group">
      ...
      <section className="py-24 bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            See how BET's advanced features can transform your business operations
          </p>
